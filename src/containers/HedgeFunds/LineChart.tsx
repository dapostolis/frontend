...
import {Typography, Theme, Table, TableHead, TableRow, TableCell, TableBody} from '@material-ui/core';

import {IChartProps} from "./Interface/IHedgeFundOutput";
